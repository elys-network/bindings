...
pub fn get_elys_earn_program_details(
    ...
    let denom = ElysDenom::Elys.as_str().to_string();
                ...
                let new_staked_position = match staked_positions.staked_position {
                    Some(staked_positions) => {
                        ...
                        for mut s in staked_positions {
                            s.staked.usd_amount =
                                s.staked.usd_amount.checked_mul(elys_price_in_usd).unwrap();
                            s.staked.usd_amount =
                                s.staked.usd_amount.checked_mul(usdc_usd_price).unwrap();
                    ...
                    Some(unstaked_positions) => {
                        ...
                        for mut s in unstaked_positions {
                            ...
                            s.unstaked.usd_amount =
                                s.unstaked.usd_amount.checked_mul(usdc_usd_price).unwrap();
